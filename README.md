...
Dedicated front end web developer with experience in leading projects and staff to create accessible websites and application that comply with [World Wide Web Consortium (W3C)](http://www.w3.org/) and [Treasury Board of Canada Secretariat (TBS)](http://www.tbs-sct.gc.ca/ws-nw/index-eng.asp) standards for the web.
...
*  Developed and maintained the [GCWeb theme](https://github.com/wet-boew/GCWeb) for the Government of Canada&#39;s [Web Experience Toolkit (WET)](https://github.com/wet-boew) project on [com](https://github.com/).
*  Administrator and contributor on the Web Experience Toolkit (WET) open source project.
*  Worked with the early adopters of the [ca](https://canada.ca/en/) theme in implementing the theme on their own websites.
...
*  Planned, developed, tested for the initial launch of new [ca](http://canada.ca/en/index.html) site in December 2013.
...
*  Developed and maintained different Government of Canada Websites including, canada.gc.ca, [gc.ca](http://www.servicecanada.gc.ca/eng/home.shtml), [pwd-online.ca](http://www.pwd-online.gc.ca/pwdh.4m.2@.jsp?lang%3Deng), seniors.gc.ca and [gc.ca](http://news.gc.ca/web/index-eng.do).
*  Built the [gc.ca](http://servicecanada.gc.ca/) template using the WET version 3.1.8 framework.
...
### Certificates from** [**Lynda.com**](https://n-hm4il5mjqex3bwezumlz4asoptduhebebqzplby-0lu-script.googleusercontent.com/userCodeAppPanel) **in the following:
...
Currently volunteering my time with the creation and maintenance of Cornwall Handi Social Club Web site.
